...
$currentPage=basename($path,'.php');
			...
			<a <?php
						if($currentPage=='online_frnd') {
							echo 'id="active"';
						}?>href="online_frnd.php">Online Friends</a>
		...
		<table width="550" align="center">
			<tr align="center">
				...
				<td colspan="4"><h2>Friends Are Currentyly Available In Online:</h2></td>
			</tr>
			<tr>
				<th>SN.:</th>
				<th>Name:</th>
...
<?php
		...
		?>
			...
			<a target="blank" href="messages.php?user_id=<?php echo $user_id ; ?>" >Messages</a>
	...
	<td>
			...
			<img style='width: 25px;height: 25px;' src="user/user_images/circle.gif" />
