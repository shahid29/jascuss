...
$currentPage=basename($path,'.php');
		...
		<table width="550" align="center">
			<tr align="center">
				<td colspan="4"><h2>My Friend List:</h2></td>
			</tr>
			<tr>
				<th>SN.:</th>
				<th>Name:</th>
...
<?php
		...
		?>
			<tr align="center">
				<td><?php echo $sn;  ?></td>
				<td>
				<a target="blank" href="user_profile.php?user_id=<?php echo $user_name ; ?>" >
	...
	if (mysqli_num_rows($chenk_frnd_query)==1) {
		echo "<a style='color:red;' href='Unfriend.php?Unfriend=Unfriend&user_id=$user_id' >X</a>";
	}
}
?>
