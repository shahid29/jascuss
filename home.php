...
//------------------------------count Friend Are Online END----------------------------------------------------------------------------
			...
			echo "
				...
				<p><a href='visitor.php?u_id=$user_id1'>Visited People</a></p>
...
<!--User timeline ends here-->	
	<div id="content_timeline">
		<form method="post" id="ct_form" action="home.php?id=<?php echo $user_id1; ?>" >

		<h2>What's your question today? Lets's discuss!</h2>
		<input type="text" name="title" placeholder="Write a Title...." required="required" /><br/>
		<textarea  name="content" placeholder="Write Description...."></textarea><br/>
		<select name="topic">
